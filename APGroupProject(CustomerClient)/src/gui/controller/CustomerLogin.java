			...
			public void actionPerformed(ActionEvent e) {
				...
				if(textFieldCustomerId.getText().equals("")||textFieldUsername.getText().equals("")||textFieldPassword.getText().equals(""))
				{
	            	...
	            	if (sendClient.isLoginStatus()) {
		            	...
		            	JOptionPane.showMessageDialog(null, "Login Failed. Invalid Details Entered.", "Login Status", JOptionPane.ERROR_MESSAGE);
		            }
	            	sendClient.closeConnection();
				}
				}catch(NumberFormatException n) {
					JOptionPane.showMessageDialog(null, "Invalid Input. ID must be an integer!", "Error Status", JOptionPane.ERROR_MESSAGE);
				}
			}
